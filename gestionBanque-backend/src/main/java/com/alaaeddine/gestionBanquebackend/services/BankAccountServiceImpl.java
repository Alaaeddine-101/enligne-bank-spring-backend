...
import com.alaaeddine.gestionBanquebackend.mappers.BankAccountMappersImpl;
...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    private BankAccountRepositoriy bankAccountRepositoriy;
    private AccountOperationRepositoriy accountOperationRepositoriy;
    ...
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, Long customerId) throws CustomerNotFoundException {
        ...
        CurrentAccount savedBankAccouunt = bankAccountRepositoriy.save(currentAccount);
        return dtoMapper.fromCurrentAccount(savedBankAccouunt);
    }
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId) throws CustomerNotFoundException {
        ...
        SavingAccount savedBankAccouunt = bankAccountRepositoriy.save(savingAccount);
        return dtoMapper.fromSavingAccount(savedBankAccouunt);
    }
...
//        }
        ...
        // la  programation fonctionnel : use of stream
    ...
    public BankAccountDTO getBankAccount(String accountId) throws BankAccountNotFoundException {
        BankAccount bankAccount =bankAccountRepositoriy.findById(accountId)
                .orElseThrow(()-> new BankAccountNotFoundException("Accont not found!!")) ;
    ...
    public void debit(String accountId, double amount, String description) throws BankAccountNotFoundException, BalanceNotSufficientException {
        ...
        bankAccountRepositoriy.save(bankAccount);
    }
    ...
    public List<BankAccountDTO> bankAccountList(){
        ...
        List<BankAccount> bankAccounts = bankAccountRepositoriy.findAll();
    ...
    public  CustomerDTO getCustomer(Long id) throws CustomerNotFoundException {
        Customer customer = customerRepositoriy.findById(id)
    ...
    public List<AccountOperationDTO> accountHistory(String accountId){
        List<AccountOperation> accountOperations = accountOperationRepositoriy.findByBankAccountId(accountId);
        return accountOperations.stream().map(op->dtoMapper.fromAccountOperation(op)).collect(Collectors.toList());
    }

    @Override
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        BankAccount bankAccount=bankAccountRepositoriy.findById(accountId).orElse(null);
        if(bankAccount==null) throw new BankAccountNotFoundException("Account not Found");
        Page<AccountOperation> accountOperations = accountOperationRepositoriy.findByBankAccountIdOrderByOperationDateDesc(accountId, PageRequest.of(page, size));
...
//
    ...
    public List<CustomerDTO> searchCustomers(String keyword) {
        List<Customer> customers=customerRepositoriy.searchCustomer(keyword);
